...
class BoardAnalyzerTests(TestBase):
    ...
    def test_should_gather_to_hold_central_point_of_defense_nearest_to_contestable_cities(self):
        ...
        map, general, enemyGeneral = self.load_map_and_generals(mapFile, 579, fill_out_tiles=True)

        rawMap, _ = self.load_map_and_general(mapFile, respect_undiscovered=True, turn=579)
