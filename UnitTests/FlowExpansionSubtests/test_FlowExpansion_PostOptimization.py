...
from BehaviorAlgorithms.FlowExpansion import FlowExpansionPlanOptionCollection, ArmyFlowExpanderV2
...
|    |    |    |
        ...
        self.assertIsInstance(result.expansion_options, list, 'Should contain a list of flow plans')
